...
import pl.sportal.common.interfaces.InterfaceJSON;
import pl.sportal.common.interfaces.InterfaceUUID;
...
import pl.sportal.common.utilities.LinkedHashMapBuilder;
...
public class Konta implements Serializable, InterfaceJSON<Konta>, InterfaceUUID<Konta>, InterfaceDatabaseObject {
    ...
    private static final String SALT = "pl.sportal.zarzadzanie.konta.";
    ...
    public String toString() {
        return "pl.sportal.jpa.Konta[ id=" + id + " ]";
    }
