...
BEGIN
	...
	CREATE SCHEMA IF NOT EXISTS serwis AUTHORIZATION postgres;	
	...
	IF serwis.czy_tabela_istnieje('ustawienia_klienta', 'serwis') = false --pkt 10
	THEN
	...
	EXECUTE serwis.dodaj_kolumne('serwis.ustawienia_klienta', 'obowiazkowe_data_urodzenia', 'boolean NOT NULL DEFAULT false'); 
	EXECUTE serwis.dodaj_kolumne('serwis.ustawienia_klienta', 'obowiazkowe_miejce_urodzenia', 'boolean NOT NULL DEFAULT false'); 
	EXECUTE serwis.dodaj_kolumne('serwis.ustawienia_klienta', 'obowiazkowe_telefon', 'boolean NOT NULL DEFAULT false'); 
	EXECUTE serwis.dodaj_kolumne('serwis.ustawienia_klienta', 'obowiazkowe_dane_adresowe', 'boolean NOT NULL DEFAULT false'); 
	EXECUTE serwis.dodaj_kolumne('serwis.ustawienia_klienta', 'maksymalna_ilosc_klientow_powiazanych', 'INTEGER'); 

        IF NOT EXISTS (SELECT * FROM serwis.ustawienia_klienta) THEN
        ...
        EXECUTE serwis.dodaj_kolumne('serwis.ustawienia_klienta', 'obowiazkowe_data_urodzenia_samodzielnie', 'boolean NOT NULL DEFAULT false', null); 
	EXECUTE serwis.dodaj_kolumne('serwis.ustawienia_klienta', 'obowiazkowe_miejce_urodzenia_samodzielnie', 'boolean NOT NULL DEFAULT false'); 
	EXECUTE serwis.dodaj_kolumne('serwis.ustawienia_klienta', 'obowiazkowe_telefon_samodzielnie', 'boolean NOT NULL DEFAULT false'); 
	EXECUTE serwis.dodaj_kolumne('serwis.ustawienia_klienta', 'obowiazkowe_dane_adresowe_samodzielnie', 'boolean NOT NULL DEFAULT false'); 

        EXECUTE serwis.dodaj_kolumne('serwis.ustawienia_klienta', 'obowiazkowe_email', 'boolean NOT NULL DEFAULT false');
        EXECUTE serwis.dodaj_kolumne('serwis.ustawienia_klienta', 'obowiazkowe_email_samodzielnie', 'boolean NOT NULL DEFAULT false');
	...
	EXECUTE serwis.dodaj_kolumne('serwis.parametry_hasla', 'minimalna_dlugosc', 'integer NOT NULL DEFAULT 8'); 
	EXECUTE serwis.dodaj_kolumne('serwis.parametry_hasla', 'liczba_znakow_specjalnych', 'integer NOT NULL DEFAULT 1'); 
	EXECUTE serwis.dodaj_kolumne('serwis.parametry_hasla', 'liczba_cyfr', 'integer NOT NULL DEFAULT 1'); 
	EXECUTE serwis.dodaj_kolumne('serwis.parametry_hasla', 'wielkosc_liter', 'boolean NOT NULL DEFAULT false'); 
	...
	EXECUTE serwis.dodaj_kolumne('serwis.blokada_konta', 'liczba_bledow', 'integer NOT NULL DEFAULT 3'); 
	EXECUTE serwis.dodaj_kolumne('serwis.blokada_konta', 'czas_blokady', 'integer NOT NULL DEFAULT 5'); 
	...
	EXECUTE serwis.dodaj_kolumne('serwis.dostep', 'dlugosc_sesji_http', 'integer NOT NULL DEFAULT 5'); 
	EXECUTE serwis.dodaj_kolumne('serwis.dostep', 'ip_rejestracja', 'text'); 
	EXECUTE serwis.dodaj_kolumne('serwis.dostep', 'ip_logowanie', 'text'); 
        EXECUTE serwis.dodaj_kolumne('serwis.dostep', 'czas_waznosci_kodu_jednorazowego', 'integer NOT NULL DEFAULT 2'); 
	...
	EXECUTE serwis.dodaj_kolumne('serwis.konfiguracja', 'aktualnosci_na_stronie_glownej', 'boolean NOT NULL DEFAULT TRUE'); 
        EXECUTE serwis.dodaj_kolumne('serwis.konfiguracja', 'recaptcha_site_key', 'TEXT'); 
        EXECUTE serwis.dodaj_kolumne('serwis.konfiguracja', 'recaptcha_secret_key', 'TEXT'); 
        EXECUTE serwis.dodaj_kolumne('serwis.konfiguracja', 'szablon_email_potwierdzenie_zalozenia_konta', 'TEXT'); 
        EXECUTE serwis.dodaj_kolumne('serwis.konfiguracja', 'szablon_email_zmiana_hasla', 'TEXT'); 
        ...
        IF serwis.czy_kolumna_istnieje('serwis.konfiguracja', 'szablon_email_powiadomienie_o_wykorzystaniu_danych') THEN
            ...
            END IF;            
        END IF;
        EXECUTE serwis.dodaj_kolumne('serwis.konfiguracja', 'szablon_email_powiadomienie_o_wykorzystaniu_danych_pesel', 'TEXT'); 
        EXECUTE serwis.dodaj_kolumne('serwis.konfiguracja', 'szablon_email_powiadomienie_o_wykorzystaniu_danych_email', 'TEXT'); 
        EXECUTE serwis.dodaj_kolumne('serwis.konfiguracja', 'szablon_email_powiadomienie_o_zmianie_hasla', 'TEXT'); 
	...
	EXECUTE serwis.dodaj_kolumne('serwis.konfiguracja_serwera_poczty', 'uzytkownik', 'TEXT'); 
	EXECUTE serwis.dodaj_kolumne('serwis.konfiguracja_serwera_poczty', 'haslo_serwera_poczty', 'TEXT'); 
	EXECUTE serwis.dodaj_kolumne('serwis.konfiguracja_serwera_poczty', 'adres_serwera_poczty', 'TEXT'); 
	EXECUTE serwis.dodaj_kolumne('serwis.konfiguracja_serwera_poczty', 'port_serwera_poczty', 'TEXT'); 
	EXECUTE serwis.dodaj_kolumne('serwis.konfiguracja_serwera_poczty', 'ssl', 'BOOLEAN'); 
	...
	EXECUTE serwis.dodaj_kolumne('serwis.konfiguracja_serwera_sms', 'sms_api_login', 'TEXT'); 
	EXECUTE serwis.dodaj_kolumne('serwis.konfiguracja_serwera_sms', 'sms_api_password', 'TEXT'); 
	EXECUTE serwis.dodaj_kolumne('serwis.konfiguracja_serwera_sms', 'serwer_sms_login', 'TEXT'); 
	EXECUTE serwis.dodaj_kolumne('serwis.konfiguracja_serwera_sms', 'serwer_sms_password', 'TEXT'); 

	-------------------------
	
	CREATE SCHEMA IF NOT EXISTS slowniki AUTHORIZATION postgres;		
	
	-------------------------
	
	IF serwis.czy_tabela_istnieje('typy_dokumentow', 'slowniki') = false 
	THEN
	...
	EXECUTE serwis.dodaj_kolumne('slowniki.typy_dokumentow', 'nazwa_dokumentu_tozsamosci', 'text NOT NULL'); 
	...
	EXECUTE serwis.dodaj_kolumne('slowniki.typy_komunikatow', 'opis', 'text NOT NULL'); 
	...
	EXECUTE serwis.dodaj_kolumne('slowniki.typy_e_dokumentow', 'opis', 'text NOT NULL'); 

	-------------------------

	IF serwis.czy_tabela_istnieje('komorki_organizacyjne', 'slowniki') = false 
	THEN
	...
	EXECUTE serwis.dodaj_kolumne('slowniki.komorki_organizacyjne', 'nazwa', 'text NOT NULL'); 
	EXECUTE serwis.dodaj_kolumne('slowniki.komorki_organizacyjne', 'opis', 'text'); 

	-------------------------
	
	IF serwis.czy_tabela_istnieje('typy_grup', 'slowniki') = false 
	THEN
	...
	EXECUTE serwis.dodaj_kolumne('slowniki.typy_grup', 'nazwa', 'text NOT NULL');
        ...
        IF serwis.czy_tabela_istnieje('typy_powiadomien','slowniki') = false 
        THEN 
	...
	CREATE SCHEMA IF NOT EXISTS uzytkownicy AUTHORIZATION postgres;
	...
	EXECUTE serwis.dodaj_kolumne('uzytkownicy.grupy', 'aktywna', 'BOOLEAN NOT NULL DEFAULT FALSE'); 
	EXECUTE serwis.dodaj_kolumne('uzytkownicy.grupy', 'domyslna', 'BOOLEAN NOT NULL DEFAULT FALSE');

	-------------------------

	IF serwis.czy_tabela_istnieje('konta', 'uzytkownicy') = false 
	THEN
	...
	EXECUTE serwis.dodaj_kolumne('uzytkownicy.konta', 'login', 'text'); 
	EXECUTE serwis.dodaj_kolumne('uzytkownicy.konta', 'email', 'text'); 
	EXECUTE serwis.dodaj_kolumne('uzytkownicy.konta', 'haslo', 'text NOT NULL'); 
	EXECUTE serwis.dodaj_kolumne('uzytkownicy.konta', 'konto_aktywne', 'BOOLEAN NOT NULL DEFAULT FALSE'); 
	EXECUTE serwis.dodaj_kolumne('uzytkownicy.konta', 'akceptacja_regulaminu', 'timestamp without time zone'); 
	EXECUTE serwis.dodaj_kolumne('uzytkownicy.konta', 'blokada_konta_do', 'timestamp without time zone'); 
	EXECUTE serwis.dodaj_kolumne('uzytkownicy.konta', 'blokada_konta', 'BOOLEAN NOT NULL DEFAULT FALSE'); 
	EXECUTE serwis.dodaj_kolumne('uzytkownicy.konta', 'potwierdzenie', 'BOOLEAN NOT NULL DEFAULT FALSE'); 
	...
	EXECUTE serwis.dodaj_kolumne('uzytkownicy.konta', 'liczba_prob_logowania', 'integer NOT NULL DEFAULT 0');
        EXECUTE serwis.dodaj_kolumne('uzytkownicy.konta', 'imie', 'text'); 
	EXECUTE serwis.dodaj_kolumne('uzytkownicy.konta', 'nazwisko', 'text'); 
	
        UPDATE uzytkownicy.konta SET uuid = replace(uuid_generate_v4()::text, '-', '') WHERE uuid IS NULL;

  
	DROP TABLE IF EXISTS uzytkownicy.konta_powiazania; 
	...
	IF serwis.czy_tabela_istnieje('klienci_powiazania', 'uzytkownicy') = false 
	THEN
	...
	IF serwis.czy_tabela_istnieje('uprawnienia', 'uzytkownicy' ) = false 
	THEN
...
--                 );
	...
	CREATE SCHEMA IF NOT EXISTS portal AUTHORIZATION postgres;

	-------------------------

	IF serwis.czy_tabela_istnieje('aktualnosci', 'portal') = false 
	THEN
	...
	END IF;
        ...
        END IF;
	EXECUTE serwis.dodaj_kolumne('portal.aktualnosci', 'data_publikacji', 'DATE NOT NULL DEFAULT (''now''::text)::date'); 
	EXECUTE serwis.dodaj_kolumne('portal.aktualnosci', 'tresc', 'text NOT NULL'); 
        EXECUTE serwis.dodaj_kolumne('portal.aktualnosci', 'tytul', 'text NOT NULL'); 
        EXECUTE serwis.dodaj_kolumne('portal.aktualnosci', 'skrot', 'text'); 
        EXECUTE serwis.dodaj_kolumne('portal.aktualnosci', 'autor', 'text'); 
        EXECUTE serwis.dodaj_kolumne('portal.aktualnosci', 'publikacja', 'boolean NOT NULL DEFAULT false');      

	-------------------------

	IF serwis.czy_tabela_istnieje('regulamin', 'portal') = false 
	THEN
	...
	EXECUTE serwis.dodaj_kolumne('portal.regulamin', 'data_dodania', 'DATE NOT NULL'); 
	EXECUTE serwis.dodaj_kolumne('portal.regulamin', 'tresc', 'text NOT NULL'); 

        IF serwis.czy_tabela_istnieje('tresci', 'portal') = false 
        THEN
	...
	CREATE SCHEMA IF NOT EXISTS dokumenty AUTHORIZATION postgres;
	...
	EXECUTE serwis.dodaj_kolumne('dokumenty.deskryptory', 'tytul', 'text not null'); 
	EXECUTE serwis.dodaj_kolumne('dokumenty.deskryptory', 'pacjent', 'text not null'); 
	EXECUTE serwis.dodaj_kolumne('dokumenty.deskryptory', 'komorka_organizacyjna', 'text not null'); 
	EXECUTE serwis.dodaj_kolumne('dokumenty.deskryptory', 'kierujacy', 'text'); 
	EXECUTE serwis.dodaj_kolumne('dokumenty.deskryptory', 'data_zatwierdzenia', 'date'); 
	EXECUTE serwis.dodaj_kolumne('dokumenty.deskryptory', 'data_utworzenia', 'date not null'); 
	EXECUTE serwis.dodaj_kolumne('dokumenty.deskryptory', 'informacja_o_aktualnosci', 'text'); 

	-------------------------

	CREATE SCHEMA IF NOT EXISTS ankiety AUTHORIZATION postgres;

	-------------------------

	CREATE SCHEMA IF NOT EXISTS powiadomienia AUTHORIZATION postgres;
	...
	CREATE SCHEMA IF NOT EXISTS logi AUTHORIZATION postgres;
